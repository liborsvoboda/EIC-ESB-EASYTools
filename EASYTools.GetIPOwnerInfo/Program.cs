using EASYTools.GetIPOwnerInfoTool.Classes;
using System;
using System.Collections.Generic;

namespace EASYTools.GetIPOwnerInfoTool {

    internal class Program {
        public static List<IPList> IPList = new List<IPList>();
        private static readonly string configFileName = "config.json";
        private static readonly Config Config = new Config() { checkOwnerIpUrl = Functions.LoadDefinedFormatFile<Config>(configFileName, true, System.Text.Json.JsonSerializer.Serialize<Config>(new Config())).checkOwnerIpUrl };
        ...
        private static void Main(string[] args) {
            ...
            if (IPList.Count == 0) {
                ...
                List<string> returnedApiInfo = new List<string>();
                IPList.ForEach(ip => {
